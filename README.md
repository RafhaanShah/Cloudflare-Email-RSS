...
## How it works
1. Emails get sent to your configured address on Cloudflare, e.g. `rss-feeds@domain.com`
...
1. Create [Security Rules](https://developers.cloudflare.com/security/rules/) to control access to your bucket (e.g. limited to your IP / Country / Header / Agent etc)
1. Create a [R2 Bucket](https://developers.cloudflare.com/r2/buckets/public-buckets/) with Public Access (this should still be protected by your previously created Security Rules)
